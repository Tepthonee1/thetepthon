...
CATLOGO = "https://telegra.ph/file/5a5e0405ab4cc48e8da63.jpg"
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:
        ...
        if query.startswith("**sbb_b"):
            buttons = [
                (
                    ...
                    Button.url("DEV", "https://t.me/FFP8F"),
                )
            ]
            ...
            result = builder.article(
                title="sbb_b Help™",
                description="**▾∮ قائمة التعليمات الخاصة ب سيـفت **",
                text=_result[0],
                buttons=_result[1],
                link_preview=False,
            )
        ...
        buttons = [
            (
                Button.url("قناة السورس", "t.me/FFP8F"),
                Button.url(
                    "المطور",
                    "t.me/SS22TT",
                ),
        ...
        text, msg_entities = await event.client._parse_message_text(
            "لجعل سيـفت من نصيبك!", "md"
        )
        result = types.InputBotInlineResult(
            id=str(uuid4()),
            type="photo",
            title="[𝗦𝗔𝗙𝗘𝗧 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 🧸♥](https://t.me/FFP8F)",
