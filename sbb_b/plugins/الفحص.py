...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**父[ 𝗦𝗔𝗙𝗘𝗧 𝙸𝚂 𝚆𝙾𝚁𝙺𝙸𝙽𝙶 ✓ ](t.me/FFP8F)父**"
...
def jmthonalive_text():
    EMOJI = gvarstatus("ALIVE_EMOJI") or "  ✥ "
    jmthon_caption = "**𝗦𝗔𝗙𝗘𝗧 𝙸𝚂 𝚆𝙾𝚁𝙺𝙸𝙽𝙶**\n"
...
ROZ_PIC = "https://telegra.ph/file/5a5e0405ab4cc48e8da63.jpg"
RAZAN = Config.TG_BOT_USERNAME
ROZ_T = (
    f"**⌯︙بوت سيـفت يعمل بنجاح 🤍،**\n"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("السورس") and event.query.user_id == sbb_b.uid:
            buttons = [
                [
                    Button.url("قنـاة السـورس ⚙️", "https://t.me/FFP8F"),
                    Button.url("المطـور 👨🏼‍💻", "https://t.me/SS22TT"),
                ]
            ]
