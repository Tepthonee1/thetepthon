# arthon
# Copyright (C) 2022 FFP8F. All Rights Reserved
#
# This file is a part of < https://github.com/arthonee/tt_1/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/FFP8Fee/theFFP8F/blob/master/LICENSE/>.
#arthon
...
async def who(event):
    ...
    try:
        ...
        return await edit_or_reply(ar, "**- لـم استطـع العثــور على الشخــص**")
